    ...
    return ListView(
      children: [
        ...
        SwitchListTile(
          ...
          subtitle: const Text('Enable for simultaneous subject groups (Hindi/Urdu/Sanskrit)'),
        ...
        if (_isElectiveGroup)
          TextField(
            ...
            decoration: const InputDecoration(labelText: 'relationshipGroupKey (e.g. LANG_GRP_10A)'),
          ),
        const SizedBox(height: 6),
        SwitchListTile(
        ...
        Align(
          ...
          child: Text('Joint Class Selector', style: Theme.of(context).textTheme.titleSmall),
        ),
        Wrap(
          spacing: 6,
